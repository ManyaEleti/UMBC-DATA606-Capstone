...
- Built introductory machine learning models and reviewed results using simple evaluation metrics.
- Explored generative AI use cases and refined outputs based on mentor feedback.
- Documented learnings and insights for review presentations.
...
- Gained exposure to analytics pipeline concepts and data quality checks.
- Assisted in building reusable workflows under mentorship.
...
- Experiment Design (A/B testing basics)
...
- MySQL
- PySpark, Spark SQL (exposure)
- Hadoop (basic exposure)
- Git, Jupyter, Linux
...
- Evaluated performance using R² and MAE.
- Created visual dashboards to support inventory planning insights.
...
- Presented findings with a focus on real-world implications.
...
- Supported data-driven decision making for sustainability and cost reduction.
...
- IBM SkillsBuild Data Science and R Analytics
- Data Science and AI Campus Program (Surge Classes)
- Machine Learning Bootcamp — Udemy
- Big Data Workshop — NIT Warangal
- Spoken Tutorials — C++
